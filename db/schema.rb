...
ActiveRecord::Schema.define(:version => 20141114060240) do
  ...
  create_table "certifications_projects", :id => false, :force => true do |t|
    t.integer "certification_id"
    t.integer "project_id"
  end

  add_index "certifications_projects", ["certification_id", "project_id"], :name => "index_certifications_projects_on_certification_id_and_project_id"
  ...
  create_table "media_moves", :id => false, :force => true do |t|
    t.integer "medium_id"
    t.integer "move_id"
  end

  add_index "media_moves", ["medium_id", "move_id"], :name => "index_media_moves_on_medium_id_and_move_id"
