  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved widget as @widget" do
        ...
        post :create, {:widget => { "title" => "invalid value" }}, valid_session
        assigns(:widget).should be_a_new(Widget)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested widget" do
        ...
        Widget.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => widget.to_param, :widget => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the widget as @widget" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Widget.any_instance.stub(:save).and_return(false)
        put :update, {:id => widget.to_param, :widget => { "title" => "invalid value" }}, valid_session
        assigns(:widget).should eq(widget)
      end
