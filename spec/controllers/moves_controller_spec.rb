  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved move as @move" do
        ...
        post :create, {:move => { "body" => "invalid value" }}, valid_session
        assigns(:move).should be_a_new(Move)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested move" do
        ...
        Move.any_instance.should_receive(:update_attributes).with({ "body" => "MyText" })
        put :update, {:id => move.to_param, :move => { "body" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the move as @move" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Move.any_instance.stub(:save).and_return(false)
        put :update, {:id => move.to_param, :move => { "body" => "invalid value" }}, valid_session
        assigns(:move).should eq(move)
      end
